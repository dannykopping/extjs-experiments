...
class Email {
	...
	var	$_attach_display_name	= array();
...
//		log_message('debug', "Email Class Initialized");
	 ...
	 * @return	void
	 */
	public function attach($filename, $displayName, $disposition = 'attachment')
	{
		$this->_attach_name[] = $filename;
		$this->_attach_display_name[] = $displayName;
	...
	private function _build_message()
	{
		...
		for ($i=0; $i < count($this->_attach_name); $i++)
		{
			...
			$basename = $this->_attach_display_name[$i];
